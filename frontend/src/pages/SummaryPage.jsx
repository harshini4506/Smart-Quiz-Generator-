      ...
      <div className="mx-auto max-w-4xl px-4">
        ...
        >
          <div className="text-center mb-8">
            ...
            <h1 className="text-4xl font-bold text-gray-800 mb-2">Comprehensive Document Summary</h1>
            <p className="text-gray-600 text-lg">Get detailed, topic-wise AI-powered summary for exam preparation</p>
          ...
          <motion.button 
            ...
            className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 px-6 py-5 text-xl font-bold text-white hover:from-blue-600 hover:to-blue-700 transition-all mb-6 shadow-lg"
          >
          ...
          {summary && (
            ...
            >
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 border-2 border-purple-300 shadow-2xl">
                <h2 className="text-3xl font-bold text-purple-900 mb-6 flex items-center gap-3 border-b-2 border-purple-200 pb-3">
                ...
                <div className="text-gray-800 leading-relaxed space-y-4">
                  {summary.summary.split('\n').map((paragraph, i) => {
                      ...
                      if (matches) {
                        ...
                        return (
                          <div key={i} className="mt-6 first:mt-0 bg-purple-50 rounded-xl p-5 border-l-4 border-purple-500">
                            ...
                            {remainingText && (
                              <p className="text-gray-700 text-base leading-relaxed ml-8">
                                {remainingText}
                              </p>
                            )}
                          </div>
                    ...
                    return trimmed.length > 20 ? (
                      <p key={i} className="text-gray-700 text-base leading-relaxed ml-8">
                        {trimmed}
                      </p>
                    ) : null;
                  })}
              ...
              {/* Key Points Section */}
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 border-2 border-green-300 shadow-2xl">
                <h2 className="text-3xl font-bold text-green-900 mb-6 flex items-center gap-3 border-b-2 border-green-200 pb-3">
              ...
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl p-8 border-2 border-blue-300 shadow-2xl">
                <h2 className="text-3xl font-bold text-blue-900 mb-6 flex items-center gap-3 border-b-2 border-blue-200 pb-3">
                ...
                <div className="flex flex-wrap gap-3">
                  {(summary.important_topics || []).map((item, idx) => (
                    <motion.span
                      ...
                      className="bg-gradient-to-r from-blue-500 to-purple-600 text-white px-5 py-3 rounded-xl font-semibold text-base shadow-lg hover:shadow-xl hover:scale-105 transition-all cursor-default"
                    >
                      {item}
                    </motion.span>
                  ))}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                onClick={downloadPDF}
                className="w-full rounded-xl bg-gradient-to-r from-red-500 to-pink-600 px-8 py-5 text-xl font-bold text-white shadow-2xl hover:from-red-600 hover:to-pink-700 transition-all flex items-center justify-center gap-3"
              >
                <span className="text-2xl">📄</span>
